...
insert into questao values (null, 'print(tipo(x))', 'print(tipo x)', 'print(typeOf(x))', 'print(tipo(x))', 'Qual é a sintaxe correta para produzir o tipo de variável ou objeto em Python?', 1);
