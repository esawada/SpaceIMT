...
//
//public class frmProfile extends JFrame {
//
...
//            public void run() {
//                frmProfile frame = new frmProfile();
...
//    public frmProfile() {
//
//        Image img_Fundo_Profile = new ImageIcon(frmMenu.class.getResource("../IMAGEM/Fundo_Menu.jpg")).getImage().getScaledInstance(1400, 1400, Image.SCALE_SMOOTH);
//        Image img_Conquista = new ImageIcon(frmMenu.class.getResource("../IMAGEM/Conquista.png")).getImage().getScaledInstance(90, 90, Image.SCALE_SMOOTH);
//        Image img_User = new ImageIcon(frmMenu.class.getResource("../IMAGEM/Nave.png")).getImage().getScaledInstance(90, 90, Image.SCALE_SMOOTH);
//        Image img_Atencao = new ImageIcon(frmMenu.class.getResource("../IMAGEM/Atencao.png")).getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
//
