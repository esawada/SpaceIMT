...
public class Aba_Options extends JFrame {
	...
	public Aba_Options() {
		Image img_Espaco = new ImageIcon(Frame.class.getResource("imgs/Espaço.jpg")).getImage().getScaledInstance(1200,710,Image.SCALE_SMOOTH);
		...
		panelCredito.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(Aba_Options,
				    ...
				    "Pedro Guilherme Luxelane Tolone. RA:  \n" +
